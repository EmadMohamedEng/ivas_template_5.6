...
<head>
    ...
    <!-- {{url('assets/jquery-cookie/jquery.cookie.js')}} -->
    <link rel="stylesheet" href=" {{asset('JIC/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('JIC/css/bootstrap-responsive.min.css')}}">
    <!-- DEMO CUSTOM STYLES -->
    <link rel="stylesheet" href="{{asset('JIC/css/demo.css')}}">
    <!-- HERE IS THE MAGIC ... -->
    <script src="{{asset('JIC/js/JIC.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('JIC/js/demo.js')}}" type="text/javascript"></script>
